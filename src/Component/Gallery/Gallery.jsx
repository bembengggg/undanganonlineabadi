...
const Gallery =()=>{
    return(
        <div className='wrap'>
           ...
           <iframe width="100%" height="315" src="https://www.youtube.com/embed/CPKqZB7C-cI" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" title={uniqueTitle}  allowfullscreen></iframe>
            </div>
